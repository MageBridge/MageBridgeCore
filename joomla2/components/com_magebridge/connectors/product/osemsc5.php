...
/**
 * MageBridge Product-connector for Open Source Excellence Membership Control version 5
 *
 * @package MageBridge
 */
class MageBridgeConnectorProductOsemsc5 extends MageBridgeConnectorProduct
{
    /*
    ...
    public function getFormField($value = null)
    {
        ...
        $query = 'SELECT `id` AS `value`, `title` AS `text` FROM `#__osemsc_acl`';
        $db = JFactory::getDBO();
        $db->setQuery($query);
