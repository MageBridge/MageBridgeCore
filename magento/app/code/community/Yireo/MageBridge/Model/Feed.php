 ...
 * Feed Model
 */
class Yireo_MageBridge_Model_Feed extends Mage_AdminNotification_Model_Feed
{
    /**
     * Return the feed URL
     */
    protected $customFeedUrl = 'www.yireo.com/extfeed?format=feed&platform=magebridge';
