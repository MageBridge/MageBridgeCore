...
if (!defined('MAGEBRIDGE_DEBUG_NOTICE')) {
    define('MAGEBRIDGE_DEBUG_NOTICE', 2);
}
if (!defined('MAGEBRIDGE_DEBUG_WARNING')) {
    define('MAGEBRIDGE_DEBUG_WARNING', 3);
}
if (!defined('MAGEBRIDGE_DEBUG_ERROR')) {
    define('MAGEBRIDGE_DEBUG_ERROR', 4);
}
if (!defined('MAGEBRIDGE_DEBUG_FEEDBACK')) {
    define('MAGEBRIDGE_DEBUG_FEEDBACK', 5);
}
if (!defined('MAGEBRIDGE_DEBUG_PROFILER')) {
