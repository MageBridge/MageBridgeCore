...
use JError, JFactory, JApplicationCms, JDatabaseDriver;
...
class JoomlaCase extends ParentTestCase
{
	 ...
	 */
	static protected function getClassMethod($methodName)
	{
		$thisObject = new self;
	 ...
	 * @return ReflectionMethod
	 */
	static protected function getObjectMethod($object, $methodName)
	{
