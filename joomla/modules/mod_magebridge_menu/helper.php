...
class ModMageBridgeMenuHelper extends MageBridgeModuleHelper
{
	...
	static public function getArguments($params = null)
	{
		...
		if (!isset($arguments[$id]))
		{
			...
			$arguments[$id] = array('count' => (int) $params->get('count', 0), 'levels' => (int) $params->get('levels', 1), 'startlevel' => (int) $params->get('startlevel', 1),);
	...
	static public function register($params = null)
	{
		...
		return array(array('api', 'magebridge_category.tree', $arguments),);
	}
	 ...
	 * @return array
	 */
	static public function setRoot($tree = null, $root_id = null)
	{
